...
func apiCounterpartiesTestServer(t *testing.T) *echo.Echo {
	t.Helper()
...
func TestAPICounterpartiesList_Returns401_NoAPIKey(t *testing.T) {
	t.Parallel()
	e := apiCounterpartiesTestServer(t)
	req := httptest.NewRequest(http.MethodGet, "/api/v1/counterparties", nil)
...
func TestAPICounterpartiesList_NilDB_Returns503(t *testing.T) {
	t.Parallel()
	e := apiCounterpartiesTestServer(t)
	req := httptest.NewRequest(http.MethodGet, "/api/v1/counterparties", nil)
